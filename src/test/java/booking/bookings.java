...
public class bookings extends base{
    ...
    public void get_allbooking() throws IOException {
        Map<String,Object> data= jsonutilis.getjsondata("qa_app.json");
    ...
    public void create_booking() throws IOException {
       ...
       Response response= (Response) RestAssured.given().baseUri((String) data.get("qaendpoint"))
                       .when().contentType(ContentType.JSON).body(payload).post("booking")
